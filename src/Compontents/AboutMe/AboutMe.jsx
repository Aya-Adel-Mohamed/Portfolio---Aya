                ...
                <div className={`container-fluid ${styles.padding} my-md-5 my-0 py-5`}>
                    <div className="row justify-content-center align-items-center py-md-5 py-0">
                        <div className="col-xl-6 col-lg-12 ">
                            ...
                            <div className={styles.social}>
                                {aboutMe?.map((about, index) =>
                                    <div className={`${styles.socialContent}`} key={index} data-aos="fade-up"  data-aos-duration="800">
                        ...
                        <div className="col-xl-6 col-lg-12  overflow-hidden">
                            <div className={`position-relative ${styles.circle}`}><div className={styles.circleTwo}></div><div className={styles.circleOne}></div>
